//! A point on the timeline, and the distance between two of them.
//!
//! Both are the tick count [`TICKS_PER_QUARTER`](crate::TICKS_PER_QUARTER)
//! addresses, and the count is private for the reason the crate's own
//! documentation gives.
